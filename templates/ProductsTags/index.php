 ...
 * @var iterable<\App\Model\Entity\ProductsTag> $productsTags
 */
?>
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $productsTag->hasValue('product') ? $this->Html->link($productsTag->product->name, ['controller' => 'Products', 'action' => 'view', $productsTag->product->id]) : '' ?></td>
                    <td><?= $productsTag->hasValue('tag') ? $this->Html->link($productsTag->tag->name, ['controller' => 'Tags', 'action' => 'view', $productsTag->tag->id]) : '' ?></td>
                    <td class="actions">
